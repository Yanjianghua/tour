DateInput = (function($) {
	...
	DateInput.prototype = {
		build: function() {
			var monthNav = $('<p class="month_nav">' + '<span class="button prev" title="">&#171;</span>' + ' <span class="month_name"></span> ' + '<span class="button next" title="">&#187;</span>' + '</p>');
			...
			var yearNav = $('<p class="year_nav">' + '<span class="button prev" title="">&#171;</span>' + ' <span class="year_name"></span> ' + '<span class="button next" title="">&#187;</span>' + '</p>');
