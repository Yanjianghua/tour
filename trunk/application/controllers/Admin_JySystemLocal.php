...
class Admin_JySystemLocal extends MY_Controller {
	...
	public function index() {
        ...
        if (!empty($input)) {
            ...
            $system = $this->JySystem_service->get_list(array("system_type"=>4));
        }

        $channel = json_decode(JySystem_model::CHANNEL_ARRAY,true);
        $this->assign("channel",$channel);
        $this->assign("system", $system['rows']);
        $this->view("admin/jysystemlocal/index");
	}
	...
	public function edit() {
        ...
        $this->assign("channel",$channel);
		$this->view("admin/jysystemlocal/edit");
	}
	...
	public function add() {
        ...
        $this->assign("type",$type);
        $this->assign("channel",$channel);
		$this->view("admin/jysystemlocal/add");
	}
