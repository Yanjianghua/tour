<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-04-18 22:45:54
         compiled from "/Library/WebServer/Documents/blog/yunguan/trunk/application/views/admin/jysysteminbound/index.html" */ ?>
<?php /*%%SmartyHeaderCode:75009792158f6263f700551-48211418%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e4f1d7dda3153ce29b3f54b271eac3267108d8c6' => 
    array (
      0 => '/Library/WebServer/Documents/blog/yunguan/trunk/application/views/admin/jysysteminbound/index.html',
      1 => 1492526747,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '75009792158f6263f700551-48211418',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_58f6263f7b8016_44893596',
  'variables' => 
  array (
    'web_name' => 0,
    'channel' => 0,
...
<?php if ($_valid && !is_callable('content_58f6263f7b8016_44893596')) {function content_58f6263f7b8016_44893596($_smarty_tpl) {?><!DOCTYPE html>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-list"></i>国内游配置内容列表</div>
								<div class="tools">
							...
							<div class="portlet-body">
								<div class="clearfix">
									<div class="btn-group">
										<button onclick="location='/Admin_JySystemInbound/add'" class="btn green" >
											新建内容 <i class="icon-plus"></i>
										</button>
									</div>
									<div class="btn-group pull-right">
										<form action="/Admin_JySystemInbound/index" method="get" class="form-horizontal" style="margin:0;" enctype="multipart/form-data" >
											<div class="btn-group">
...
?>
									<tr class="">
										...
										<td>
										<a class="btn_g icn-only <?php if ($_smarty_tpl->tpl_vars['v']->value['status']) {?>yellow<?php } else { ?>blue<?php }?>" href="/Admin_JySystemInbound/<?php if ($_smarty_tpl->tpl_vars['v']->value['status']) {?>disable<?php } else { ?>enable<?php }?>?system_id=<?php echo $_smarty_tpl->tpl_vars['v']->value['system_id'];?>
">
											<?php echo status_btn($_smarty_tpl->tpl_vars['v']->value['status']);?>

										</a>&nbsp;&nbsp;
										<a class="btn_g purple icn-only" href="/Admin_JySystemInbound/edit?system_id=<?php echo $_smarty_tpl->tpl_vars['v']->value['system_id'];?>
&system_class=<?php if (!empty($_smarty_tpl->tpl_vars['system_class']->value)) {
echo $_smarty_tpl->tpl_vars['system_class']->value;
}?>">
											修改
										</a>&nbsp;&nbsp;
										<a class="btn_g red icn-only" href="/Admin_JySystemInbound/del?system_id=<?php echo $_smarty_tpl->tpl_vars['v']->value['system_id'];?>
">
											删除
										</a>
										</td>
