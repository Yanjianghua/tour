<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-04-22 23:09:00
         compiled from "/Library/WebServer/Documents/blog/yunguan/trunk/application/views/admin/jythemetour/index.html" */ ?>
<?php /*%%SmartyHeaderCode:203566002758c11564231fd5-78451127%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '362e0beac1c8eb6bac955628ffeb15612809cd27' => 
    array (
      0 => '/Library/WebServer/Documents/blog/yunguan/trunk/application/views/admin/jythemetour/index.html',
      1 => 1492832754,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '203566002758c11564231fd5-78451127',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_58c115642d9a10_52038161',
  'variables' => 
  array (
    'web_name' => 0,
    'theme' => 0,
...
<?php if ($_valid && !is_callable('content_58c115642d9a10_52038161')) {function content_58c115642d9a10_52038161($_smarty_tpl) {?><!DOCTYPE html>
...
?>
									<tr class="">
										...
										<td>
										<a class="btn_g icn-only <?php if (!$_smarty_tpl->tpl_vars['v']->value['status']) {?>red<?php } else { ?>blue<?php }?>" href="/Admin_JyThemeTour/<?php if ($_smarty_tpl->tpl_vars['v']->value['status']) {?>disable<?php } else { ?>enable<?php }?>?theme_id=<?php echo $_smarty_tpl->tpl_vars['v']->value['theme_id'];?>
">
											<?php echo status_btn($_smarty_tpl->tpl_vars['v']->value['status']);?>

										</a>&nbsp;&nbsp;
										<a class="btn_g icn-only <?php if ($_smarty_tpl->tpl_vars['v']->value['status']==2) {?>red<?php } else { ?>blue<?php }?>" href="/Admin_JyThemeTour/<?php if ($_smarty_tpl->tpl_vars['v']->value['status']==2) {?>enable<?php } else { ?>recommend<?php }?>?theme_id=<?php echo $_smarty_tpl->tpl_vars['v']->value['theme_id'];?>
">
											<?php if ($_smarty_tpl->tpl_vars['v']->value['status']==2) {?>取消<?php } else { ?>推荐<?php }?>
										</a>&nbsp;&nbsp;
										<a class="btn_g icn-only <?php if ($_smarty_tpl->tpl_vars['v']->value['status']==3) {?>red<?php } else { ?>blue<?php }?>" href="/Admin_JyThemeTour/<?php if ($_smarty_tpl->tpl_vars['v']->value['status']==3) {?>enable<?php } else { ?>group<?php }?>?theme_id=<?php echo $_smarty_tpl->tpl_vars['v']->value['theme_id'];?>
">
...
">
										...
										<a class="btn_g yellow icn-only" href="/Admin_JyThemeTour/del?theme_id=<?php echo $_smarty_tpl->tpl_vars['v']->value['theme_id'];?>
">
											删除
										</a>
										</td>
