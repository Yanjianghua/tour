<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-04-18 22:52:19
         compiled from "/Library/WebServer/Documents/blog/yunguan/trunk/application/views/admin/jysystemlocal/edit.html" */ ?>
<?php /*%%SmartyHeaderCode:33587935758f62823d91294-19776974%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6d835da0ac9edfb478f48a8e4d7d67bb022d04ce' => 
    array (
      0 => '/Library/WebServer/Documents/blog/yunguan/trunk/application/views/admin/jysystemlocal/edit.html',
      1 => 1492527113,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '33587935758f62823d91294-19776974',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_58f62823e1fe12_24665732',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58f62823e1fe12_24665732')) {function content_58f62823e1fe12_24665732($_smarty_tpl) {?><!DOCTYPE html>
					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							<li>
								...
								<a href="/Admin_JySystemLocal/index">本地游玩配置管理</a>
							</li>
						</ul>
					</div>
				</div>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i>本地游玩配置修改</div>
								<div class="tools">
							...
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form action="/Admin_JySystemLocal/edit?system_class=<?php if (!empty($_smarty_tpl->tpl_vars['system_class']->value)) {
echo $_smarty_tpl->tpl_vars['system_class']->value;
}?>" method="post" class="form-horizontal" enctype="multipart/form-data" >
									<div class="control-group">
										<label class="control-label">名称：</label>
										<div class="controls">
											<input type="hidden" name="system_type" value="4">
