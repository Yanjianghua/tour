<?php /* Smarty version Smarty-3.1.21-dev, created on 2016-12-21 23:47:24
         compiled from "/Library/WebServer/Documents/blog/blog/trunk/application/views/admin/myblogmessage/add.html" */ ?>
<?php /*%%SmartyHeaderCode:282716155585aa2835db602-20159878%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2bce0960c40dc0bc0cbda08271abf56a86d0a956' => 
    array (
      0 => '/Library/WebServer/Documents/blog/blog/trunk/application/views/admin/myblogmessage/add.html',
      1 => 1482335227,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '282716155585aa2835db602-20159878',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_585aa2836107f1_08558900',
  'variables' => 
  array (
    'web_name' => 0,
  ),
...
<?php if ($_valid && !is_callable('content_585aa2836107f1_08558900')) {function content_585aa2836107f1_08558900($_smarty_tpl) {?><!DOCTYPE html>
					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							<li>
								...
								<a href="/Admin_MyBlogChannel/index">博客留言板管理</a>
							</li>
						</ul>
					</div>
				</div>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i>博客留言板添加</div>
								<div class="tools">
							...
							<div class="portlet-body form">
								...
								<form action="/Admin_MyBlogMessage/add" method="post" class="form-horizontal">
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="message_name" placeholder="请输入留言板标题，最少2位字符" minlength="2" maxlength="18" class="span6 m-wrap" />
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="tel" name="message_telephone" placeholder="请输入电话" minlength="8" maxlength="11" class="span6 m-wrap" />
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="email" name="message_email" placeholder="请输入邮箱" class="span6 m-wrap" />
									...
									<div class="control-group">
										...
										<div class="controls">
											<input class="span6 m-wrap" type="text" name="message_note" placeholder="请输入内容" />
										</div>
									</div>
