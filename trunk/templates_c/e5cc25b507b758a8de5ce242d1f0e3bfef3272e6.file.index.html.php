<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-04-18 15:12:25
         compiled from "/Library/WebServer/Documents/blog/yunguan/trunk/application/views/admin/jyorder/index.html" */ ?>
<?php /*%%SmartyHeaderCode:53155903358c25376b606d4-33977631%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e5cc25b507b758a8de5ce242d1f0e3bfef3272e6' => 
    array (
      0 => '/Library/WebServer/Documents/blog/yunguan/trunk/application/views/admin/jyorder/index.html',
      1 => 1492499213,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '53155903358c25376b606d4-33977631',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_58c25376be61a3_46230829',
  'variables' => 
  array (
    'web_name' => 0,
    'order' => 0,
...
<?php if ($_valid && !is_callable('content_58c25376be61a3_46230829')) {function content_58c25376be61a3_46230829($_smarty_tpl) {?><!DOCTYPE html>
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<h3 class="page-title">
							 预约客户管理
							<small>Background management ad</small>
						</h3>
						<ul class="breadcrumb">
							<li>
								<i class="icon-home"></i>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-list"></i>预约客户内容列表</div>
								<div class="tools">
							...
							<div class="portlet-body">
								<div class="clearfix">
									<div class="btn-group">
										<button onclick="location='/Admin_JyOrder/add'" class="btn green" >
...
?>
									<tr class="">
										...
										<td><?php echo cut_str($_smarty_tpl->tpl_vars['v']->value['order_name'],20);?>
</td>
										<td><?php echo $_smarty_tpl->tpl_vars['v']->value['order_class_tour'];?>
</td>
										<td><?php echo $_smarty_tpl->tpl_vars['v']->value['order_correlation'];?>
</td>
										<td><?php echo $_smarty_tpl->tpl_vars['v']->value['order_username'];?>
</td>
										<td><?php echo $_smarty_tpl->tpl_vars['v']->value['order_tel'];?>
</td>
										<td><?php echo date("Y-m-d",$_smarty_tpl->tpl_vars['v']->value['order_start_time']);?>
</td>
										<td><?php echo $_smarty_tpl->tpl_vars['v']->value['order_adult'];?>
</td>
										<td><?php echo $_smarty_tpl->tpl_vars['v']->value['order_children'];?>
</td>
										<td><?php echo status($_smarty_tpl->tpl_vars['v']->value['status']);?>
</td>
										<td>
										<a class="btn_g icn-only <?php if ($_smarty_tpl->tpl_vars['v']->value['status']) {?>yellow<?php } else { ?>blue<?php }?>" href="/Admin_JyOrder/<?php if ($_smarty_tpl->tpl_vars['v']->value['status']) {?>disable<?php } else { ?>enable<?php }?>?order_id=<?php echo $_smarty_tpl->tpl_vars['v']->value['order_id'];?>
">
											<?php echo status_btn($_smarty_tpl->tpl_vars['v']->value['status']);?>

										</a>&nbsp;&nbsp;
										<a class="btn_g purple icn-only" href="/Admin_JyOrder/edit?order_id=<?php echo $_smarty_tpl->tpl_vars['v']->value['order_id'];?>
">
											修改
										</a>&nbsp;&nbsp;
										<a class="btn_g red icn-only" href="/Admin_JyOrder/del?order_id=<?php echo $_smarty_tpl->tpl_vars['v']->value['order_id'];?>
">
											删除
										</a>
										</td>
