<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-03-17 23:13:43
         compiled from "/Library/WebServer/Documents/blog/yunguan/trunk/application/views/default/wap/theme/details.html" */ ?>
<?php /*%%SmartyHeaderCode:146223482358cbfd278a2112-51636192%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '292c58970e10404c6994bc8d79e68723b71b7f08' => 
    array (
      0 => '/Library/WebServer/Documents/blog/yunguan/trunk/application/views/default/wap/theme/details.html',
      1 => 1489763591,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '146223482358cbfd278a2112-51636192',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_58cbfd27905118_23949721',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58cbfd27905118_23949721')) {function content_58cbfd27905118_23949721($_smarty_tpl) {?><!DOCTYPE html>
...
<div id="header-box" class="wap-pst-r">
    <header class="wap-bg-5 wap-pst-r" id="listheader">
        <h3 class="wap-fnts-2"><?php echo cut_str($_smarty_tpl->tpl_vars['theme']->value['theme_name'],10);?>
</h3>
        <a href="#" class="list-top-a1"  id="check"><img src="/statics/wap/images/fkico.png" /></a>
        <a href="/m/theme" class="list-top-a2"><img src="/statics/wap/images/jtico.png" /></a>
    </header>
...
>
    ...
    <div class="swiper-container wap-max-h-1">
        <ul class="swiper-wrapper">
            <li class="swiper-slide"><img src="<?php echo $_smarty_tpl->tpl_vars['theme']->value['theme_pic1'];?>
" width="414" height="150" /> </li>
            <li class="swiper-slide"><img src="<?php echo $_smarty_tpl->tpl_vars['theme']->value['theme_pic2'];?>
" width="414" height="150" /> </li>
        </ul>
        <div class="numbox">
            <div class="numbg"></div>
...
<section class="contentbox wap-bg-2">
    <div class="contentlist">
        ...
        <ul class="content-ul">
            <li>出发地<i><?php echo $_smarty_tpl->tpl_vars['theme']->value['theme_start_name'];?>
</i></li>
            <li>目的地<i><?php echo $_smarty_tpl->tpl_vars['theme']->value['theme_end_name'];?>
</i></li>
            <li><span>￥<?php echo $_smarty_tpl->tpl_vars['theme']->value['theme_market_price'];?>
<em>起/份</em></span></li>
        </ul>
    </div>
...
<a href="/m/order?id=<?php echo $_smarty_tpl->tpl_vars['theme']->value['theme_id'];?>
&class=主题游&name=<?php echo $_smarty_tpl->tpl_vars['theme']->value['theme_name'];?>
