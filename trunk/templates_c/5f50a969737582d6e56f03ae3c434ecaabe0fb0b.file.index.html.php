<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-04-18 22:50:21
         compiled from "/Library/WebServer/Documents/blog/yunguan/trunk/application/views/admin/jysystemlocal/index.html" */ ?>
<?php /*%%SmartyHeaderCode:41737912358f627ad27b015-23638632%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5f50a969737582d6e56f03ae3c434ecaabe0fb0b' => 
    array (
      0 => '/Library/WebServer/Documents/blog/yunguan/trunk/application/views/admin/jysystemlocal/index.html',
      1 => 1492526904,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '41737912358f627ad27b015-23638632',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_58f627ad340799_31268937',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58f627ad340799_31268937')) {function content_58f627ad340799_31268937($_smarty_tpl) {?><!DOCTYPE html>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-list"></i>本地游玩配置内容列表</div>
								<div class="tools">
							...
							<div class="portlet-body">
								<div class="clearfix">
									<div class="btn-group">
										<button onclick="location='/Admin_JySystemLocal/add'" class="btn green" >
											新建内容 <i class="icon-plus"></i>
										</button>
									</div>
									<div class="btn-group pull-right">
										<form action="/Admin_JySystemLocal/index" method="get" class="form-horizontal" style="margin:0;" enctype="multipart/form-data" >
											<div class="btn-group">
...
?>
									<tr class="">
										...
										<td>
										<a class="btn_g icn-only <?php if ($_smarty_tpl->tpl_vars['v']->value['status']) {?>yellow<?php } else { ?>blue<?php }?>" href="/Admin_JySystemLocal/<?php if ($_smarty_tpl->tpl_vars['v']->value['status']) {?>disable<?php } else { ?>enable<?php }?>?system_id=<?php echo $_smarty_tpl->tpl_vars['v']->value['system_id'];?>
">
											<?php echo status_btn($_smarty_tpl->tpl_vars['v']->value['status']);?>

										</a>&nbsp;&nbsp;
										<a class="btn_g purple icn-only" href="/Admin_JySystemLocal/edit?system_id=<?php echo $_smarty_tpl->tpl_vars['v']->value['system_id'];?>
&system_class=<?php if (!empty($_smarty_tpl->tpl_vars['system_class']->value)) {
echo $_smarty_tpl->tpl_vars['system_class']->value;
}?>">
											修改
										</a>&nbsp;&nbsp;
										<a class="btn_g red icn-only" href="/Admin_JySystemLocal/del?system_id=<?php echo $_smarty_tpl->tpl_vars['v']->value['system_id'];?>
">
											删除
										</a>
										</td>
