<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-03-17 22:59:43
         compiled from "/Library/WebServer/Documents/blog/yunguan/trunk/application/views/default/wap/inbound/details.html" */ ?>
<?php /*%%SmartyHeaderCode:183196785358cbf99dbfa694-17568056%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '52004b6f879d734e1aaf0179f95be49994e908e2' => 
    array (
      0 => '/Library/WebServer/Documents/blog/yunguan/trunk/application/views/default/wap/inbound/details.html',
      1 => 1489762754,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '183196785358cbf99dbfa694-17568056',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_58cbf99dc57529_46860250',
  'variables' => 
  array (
    'inbound' => 0,
  ),
...
<?php if ($_valid && !is_callable('content_58cbf99dc57529_46860250')) {function content_58cbf99dc57529_46860250($_smarty_tpl) {?><!DOCTYPE html>
...
<div id="header-box" class="wap-pst-r">
    <header class="wap-bg-5 wap-pst-r" id="listheader">
        <h3 class="wap-fnts-2"><?php echo cut_str($_smarty_tpl->tpl_vars['inbound']->value['inbound_name'],10);?>
</h3>
        <a href="#" class="list-top-a1"  id="check"><img src="/statics/wap/images/fkico.png" /></a>
        <a href="/m/inbound" class="list-top-a2"><img src="/statics/wap/images/jtico.png" /></a>
    </header>
...
>
    ...
    <div class="swiper-container wap-max-h-1">
        <ul class="swiper-wrapper">
            <li class="swiper-slide"><img src="<?php echo $_smarty_tpl->tpl_vars['inbound']->value['inbound_pic1'];?>
" width="414" height="150" /> </li>
            <li class="swiper-slide"><img src="<?php echo $_smarty_tpl->tpl_vars['inbound']->value['inbound_pic2'];?>
" width="414" height="150" /> </li>
        </ul>
        <div class="numbox">
            <div class="numbg"></div>
...
<section class="contentbox wap-bg-2">
    <div class="contentlist">
        <h3><?php echo $_smarty_tpl->tpl_vars['inbound']->value['inbound_name'];?>
</h3>
        <ul class="content-ul">
            <li>出发地<i><?php echo $_smarty_tpl->tpl_vars['inbound']->value['inbound_start_name'];?>
</i></li>
            <li>目的地<i><?php echo $_smarty_tpl->tpl_vars['inbound']->value['inbound_end_name'];?>
</i></li>
            <li><span>￥<?php echo $_smarty_tpl->tpl_vars['inbound']->value['inbound_market_price'];?>
<em>起/份</em></span></li>
        </ul>
    </div>
...
<a href="/m/order?id=<?php echo $_smarty_tpl->tpl_vars['inbound']->value['inbound_id'];?>
&class=国内游&name=<?php echo $_smarty_tpl->tpl_vars['inbound']->value['inbound_name'];?>
