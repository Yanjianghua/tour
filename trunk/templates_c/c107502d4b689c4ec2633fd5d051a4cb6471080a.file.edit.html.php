<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-04-18 23:03:51
         compiled from "/Library/WebServer/Documents/blog/yunguan/trunk/application/views/admin/jysystemticket/edit.html" */ ?>
<?php /*%%SmartyHeaderCode:151371894058f62ad79033a0-00829487%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c107502d4b689c4ec2633fd5d051a4cb6471080a' => 
    array (
      0 => '/Library/WebServer/Documents/blog/yunguan/trunk/application/views/admin/jysystemticket/edit.html',
      1 => 1492527765,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '151371894058f62ad79033a0-00829487',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_58f62ad7990740_75668422',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58f62ad7990740_75668422')) {function content_58f62ad7990740_75668422($_smarty_tpl) {?><!DOCTYPE html>
					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							<li>
								...
								<a href="/Admin_JySystemTicket/index">景点门票配置管理</a>
							</li>
						</ul>
					</div>
				</div>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i>景点门票配置修改</div>
								<div class="tools">
							...
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form action="/Admin_JySystemTicket/edit?system_class=<?php if (!empty($_smarty_tpl->tpl_vars['system_class']->value)) {
echo $_smarty_tpl->tpl_vars['system_class']->value;
}?>" method="post" class="form-horizontal" enctype="multipart/form-data" >
									<div class="control-group">
										<label class="control-label">名称：</label>
										<div class="controls">
											<input type="hidden" name="system_type" value="5">
