<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-04-18 15:11:54
         compiled from "/Library/WebServer/Documents/blog/yunguan/trunk/application/views/admin/jysystem/index.html" */ ?>
<?php /*%%SmartyHeaderCode:11136204658bfc58ad47a10-85863933%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3c973f5aba89f0a307d67130b8a5af3a7cf26709' => 
    array (
      0 => '/Library/WebServer/Documents/blog/yunguan/trunk/application/views/admin/jysystem/index.html',
      1 => 1492499239,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '11136204658bfc58ad47a10-85863933',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_58bfc58adc6217_86409454',
  'variables' => 
  array (
    'web_name' => 0,
    'system' => 0,
...
<?php if ($_valid && !is_callable('content_58bfc58adc6217_86409454')) {function content_58bfc58adc6217_86409454($_smarty_tpl) {?><!DOCTYPE html>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-list"></i>旅游配置内容列表</div>
								<div class="tools">
							...
							<div class="portlet-body">
								<div class="clearfix">
									<div class="btn-group">
										<button onclick="location='/Admin_JySystem/add'" class="btn green" >
...
?>
									<tr class="">
										...
										<td>
										<a class="btn_g icn-only <?php if ($_smarty_tpl->tpl_vars['v']->value['status']) {?>yellow<?php } else { ?>blue<?php }?>" href="/Admin_JySystem/<?php if ($_smarty_tpl->tpl_vars['v']->value['status']) {?>disable<?php } else { ?>enable<?php }?>?system_id=<?php echo $_smarty_tpl->tpl_vars['v']->value['system_id'];?>
">
											<?php echo status_btn($_smarty_tpl->tpl_vars['v']->value['status']);?>

										</a>&nbsp;&nbsp;
										<a class="btn_g purple icn-only" href="/Admin_JySystem/edit?system_id=<?php echo $_smarty_tpl->tpl_vars['v']->value['system_id'];?>
">
											修改
										</a>&nbsp;&nbsp;
										<a class="btn_g red icn-only" href="/Admin_JySystem/del?system_id=<?php echo $_smarty_tpl->tpl_vars['v']->value['system_id'];?>
">
											删除
										</a>
										</td>
