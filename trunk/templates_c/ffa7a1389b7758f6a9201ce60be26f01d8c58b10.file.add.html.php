<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-04-22 23:14:24
         compiled from "/Library/WebServer/Documents/blog/yunguan/trunk/application/views/admin/jythemetour/add.html" */ ?>
<?php /*%%SmartyHeaderCode:97913580458c11567d178a1-87201442%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ffa7a1389b7758f6a9201ce60be26f01d8c58b10' => 
    array (
      0 => '/Library/WebServer/Documents/blog/yunguan/trunk/application/views/admin/jythemetour/add.html',
      1 => 1492873562,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '97913580458c11567d178a1-87201442',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_58c11567dc3e99_90766209',
  'variables' => 
  array (
    'web_name' => 0,
    'channel_1' => 0,
...
<?php if ($_valid && !is_callable('content_58c11567dc3e99_90766209')) {function content_58c11567dc3e99_90766209($_smarty_tpl) {?><!DOCTYPE html>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i>主题游内容添加</div>
								<div class="tools">
							...
							<div class="portlet-body form">
								...
								<form action="/Admin_JyThemeTour/add" method="post" class="form-horizontal" enctype="multipart/form-data" >
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="theme_name" placeholder="请输入内容标题，最少2位字符" minlength="2" maxlength="88" class="span6 m-wrap" />
...
"><?php echo $_smarty_tpl->tpl_vars['v']->value['system_name'];?>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input class="span6 m-wrap" type="text" name="theme_spot" placeholder="请输入景点" />
									...
									<div class="control-group">
										...
										<div class="controls">
											<input class="span6 m-wrap" type="text" name="theme_tel" placeholder="请输入商家电话" />
									...
									<div class="control-group">
										...
										<div class="controls">
											<input class="span6 m-wrap" type="text" name="theme_address" placeholder="请输入商家地址" />
									...
									<div class="control-group">
										...
										<div class="controls">
											<input class="span6 m-wrap" type="text" name="theme_cost_price" placeholder="请输入原价" />
									...
									<div class="control-group">
										...
										<div class="controls">
											<input class="span6 m-wrap" type="text" name="theme_market_price" placeholder="请输入现价" />
									...
									<div class="control-group">
										...
										<div class="controls">
											<textarea id="content123" name="theme_details" ></textarea>
											<?php echo '<script'; ?>
...
>
									...
									<div class="control-group">
										...
										<div class="controls">
											<textarea id="content12" name="theme_explain" ></textarea>
											<?php echo '<script'; ?>
 type="text/javascript">
