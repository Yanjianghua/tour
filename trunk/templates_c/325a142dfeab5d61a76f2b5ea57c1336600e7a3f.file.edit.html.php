<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-03-08 14:57:49
         compiled from "/Library/WebServer/Documents/blog/yunguan/trunk/application/views/admin/myuser/edit.html" */ ?>
<?php /*%%SmartyHeaderCode:50209474858bfab6dca9036-01396670%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '325a142dfeab5d61a76f2b5ea57c1336600e7a3f' => 
    array (
      0 => '/Library/WebServer/Documents/blog/yunguan/trunk/application/views/admin/myuser/edit.html',
      1 => 1480774303,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '50209474858bfab6dca9036-01396670',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_58bfab6dd26702_43685370',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58bfab6dd26702_43685370')) {function content_58bfab6dd26702_43685370($_smarty_tpl) {?><!DOCTYPE html>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i>用户修改</div>
								<div class="tools">
							...
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form action="/Admin_MyUser/edit" method="post" class="form-horizontal">
...
" placeholder="请输入账户名称，最少6位字符" minlength="6" maxlength="18" class="span6 m-wrap" />
									...
									<div class="control-group">
										...
										<div class="controls">
											<input class="span6 m-wrap" type="text" name="real_name" value="<?php echo $_smarty_tpl->tpl_vars['user']->value['real_name'];?>
" minlength="6" placeholder="请输入昵称" />
									...
									<div class="control-group">
										...
										<div class="controls">
											<input class="span6 m-wrap" type="tel" name="mobile" value="<?php echo $_smarty_tpl->tpl_vars['user']->value['mobile'];?>
" placeholder="请输入手机号" />
									...
									<div class="control-group">
										...
										<div class="controls">
											<input class="span6 m-wrap" type="email" name="email" value="<?php echo $_smarty_tpl->tpl_vars['user']->value['email'];?>
" placeholder="请输入邮箱" />
...
?>
												<?php if ($_smarty_tpl->tpl_vars['v']->value['group_id']==$_smarty_tpl->tpl_vars['user']->value['user_group']) {?>
												<option value="<?php echo $_smarty_tpl->tpl_vars['v']->value['group_id'];?>
" selected><?php echo $_smarty_tpl->tpl_vars['v']->value['group_name'];?>
</option>
												<?php } else { ?>
												<option value="<?php echo $_smarty_tpl->tpl_vars['v']->value['group_id'];?>
