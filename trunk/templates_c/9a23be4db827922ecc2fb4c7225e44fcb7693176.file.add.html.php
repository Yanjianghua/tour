<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-04-22 22:52:56
         compiled from "/Library/WebServer/Documents/blog/yunguan/trunk/application/views/admin/jyoutboundtour/add.html" */ ?>
<?php /*%%SmartyHeaderCode:7657126558c0fadcca5764-77546133%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9a23be4db827922ecc2fb4c7225e44fcb7693176' => 
    array (
      0 => '/Library/WebServer/Documents/blog/yunguan/trunk/application/views/admin/jyoutboundtour/add.html',
      1 => 1492872625,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '7657126558c0fadcca5764-77546133',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_58c0fadcd43416_07823680',
  'variables' => 
  array (
    'web_name' => 0,
    'channel_1' => 0,
...
<?php if ($_valid && !is_callable('content_58c0fadcd43416_07823680')) {function content_58c0fadcd43416_07823680($_smarty_tpl) {?><!DOCTYPE html>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i>出境游内容添加</div>
								<div class="tools">
							...
							<div class="portlet-body form">
								...
								<form action="/Admin_JyOutboundTour/add" method="post" class="form-horizontal" enctype="multipart/form-data" >
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="outbound_name" placeholder="请输入内容标题，最少2位字符" minlength="2" maxlength="88" class="span6 m-wrap" />
...
"><?php echo $_smarty_tpl->tpl_vars['v']->value['system_name'];?>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input class="span6 m-wrap" type="text" name="outbound_spot" placeholder="请输入景点" />
									...
									<div class="control-group">
										...
										<div class="controls">
											<input class="span6 m-wrap" type="text" name="outbound_tel" placeholder="请输入商家电话" />
									...
									<div class="control-group">
										...
										<div class="controls">
											<input class="span6 m-wrap" type="text" name="outbound_address" placeholder="请输入商家地址" />
									...
									<div class="control-group">
										...
										<div class="controls">
											<input class="span6 m-wrap" type="text" name="outbound_cost_price" placeholder="请输入原价" />
									...
									<div class="control-group">
										...
										<div class="controls">
											<input class="span6 m-wrap" type="text" name="outbound_market_price" placeholder="请输入现价" />
									...
									<div class="control-group">
										...
										<div class="controls">
											<textarea id="content123" name="outbound_details" ></textarea>
											<?php echo '<script'; ?>
...
>
									...
									<div class="control-group">
										...
										<div class="controls">
											<textarea id="content12" name="outbound_explain" ></textarea>
											<?php echo '<script'; ?>
 type="text/javascript">
