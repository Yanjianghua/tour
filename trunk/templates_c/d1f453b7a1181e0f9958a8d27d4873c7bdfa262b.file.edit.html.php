<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-04-18 22:59:08
         compiled from "/Library/WebServer/Documents/blog/yunguan/trunk/application/views/admin/jysystemtheme/edit.html" */ ?>
<?php /*%%SmartyHeaderCode:151576958558f629bc82f977-43996840%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd1f453b7a1181e0f9958a8d27d4873c7bdfa262b' => 
    array (
      0 => '/Library/WebServer/Documents/blog/yunguan/trunk/application/views/admin/jysystemtheme/edit.html',
      1 => 1492527521,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '151576958558f629bc82f977-43996840',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_58f629bc8c99a9_35801045',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58f629bc8c99a9_35801045')) {function content_58f629bc8c99a9_35801045($_smarty_tpl) {?><!DOCTYPE html>
					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							<li>
								...
								<a href="/Admin_JySystemTheme/index">主题游配置管理</a>
							</li>
						</ul>
					</div>
				</div>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i>主题游配置修改</div>
								<div class="tools">
							...
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form action="/Admin_JySystemTheme/edit?system_class=<?php if (!empty($_smarty_tpl->tpl_vars['system_class']->value)) {
echo $_smarty_tpl->tpl_vars['system_class']->value;
}?>" method="post" class="form-horizontal" enctype="multipart/form-data" >
									<div class="control-group">
										<label class="control-label">名称：</label>
										<div class="controls">
											<input type="hidden" name="system_type" value="6">
