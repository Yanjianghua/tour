<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-04-18 22:18:55
         compiled from "/Library/WebServer/Documents/blog/yunguan/trunk/application/views/admin/jysystemaround/edit.html" */ ?>
<?php /*%%SmartyHeaderCode:28081487758f60a908489a4-32439736%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '65aa30013760c71e36d1a9c9b6c01f7267027621' => 
    array (
      0 => '/Library/WebServer/Documents/blog/yunguan/trunk/application/views/admin/jysystemaround/edit.html',
      1 => 1492524963,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '28081487758f60a908489a4-32439736',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_58f60a908acb42_48468510',
  'variables' => 
  array (
    'web_name' => 0,
    'system_class' => 0,
...
<?php if ($_valid && !is_callable('content_58f60a908acb42_48468510')) {function content_58f60a908acb42_48468510($_smarty_tpl) {?><!DOCTYPE html>
					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							<li>
								...
								<a href="/Admin_JySystemAround/index">周边游配置管理</a>
							</li>
						</ul>
					</div>
				</div>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i>周边游配置修改</div>
								<div class="tools">
							...
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form action="/Admin_JySystemAround/edit?system_class=<?php if (!empty($_smarty_tpl->tpl_vars['system_class']->value)) {
echo $_smarty_tpl->tpl_vars['system_class']->value;
}?>" method="post" class="form-horizontal" enctype="multipart/form-data" >
									<div class="control-group">
										<label class="control-label">名称：</label>
										<div class="controls">
											<input type="hidden" name="system_type" value="1">
