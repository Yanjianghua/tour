<?php /* Smarty version Smarty-3.1.21-dev, created on 2016-12-21 23:53:01
         compiled from "/Library/WebServer/Documents/blog/blog/trunk/application/views/admin/myblogmessage/edit.html" */ ?>
<?php /*%%SmartyHeaderCode:994247581585aa494d95a60-66715412%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'de15cd39d487801f23a080140696a424fc24372a' => 
    array (
      0 => '/Library/WebServer/Documents/blog/blog/trunk/application/views/admin/myblogmessage/edit.html',
      1 => 1482335578,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '994247581585aa494d95a60-66715412',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_585aa494de41f8_62167077',
  'variables' => 
  array (
    'web_name' => 0,
    'message' => 0,
...
<?php if ($_valid && !is_callable('content_585aa494de41f8_62167077')) {function content_585aa494de41f8_62167077($_smarty_tpl) {?><!DOCTYPE html>
					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							<li>
								...
								<a href="/Admin_MyBlogMessage/index">博客留言板管理</a>
							</li>
						</ul>
					</div>
				</div>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i>博客留言板修改</div>
								<div class="tools">
							...
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form action="/Admin_MyBlogMessage/add" method="post" class="form-horizontal">
									<div class="control-group">
										<label class="control-label">留言板标题：</label>
										<div class="controls">
											<input type="hidden" name="message_id" value="<?php echo $_smarty_tpl->tpl_vars['message']->value['message_id'];?>
" />
											<input type="text" name="message_title" value="<?php echo $_smarty_tpl->tpl_vars['message']->value['message_title'];?>
" placeholder="请输入留言板标题，最少2位字符" minlength="2" maxlength="18" class="span6 m-wrap" />
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="tel" name="message_telephone" value="<?php echo $_smarty_tpl->tpl_vars['message']->value['message_telephone'];?>
" placeholder="请输入电话" minlength="8" maxlength="11" class="span6 m-wrap" />
											<span class="help-inline">请输入11位手机号</span>
										</div>
									</div>
									<div class="control-group">
										<label class="control-label">邮箱：</label>
										<div class="controls">
											<input type="email" name="message_email" value="<?php echo $_smarty_tpl->tpl_vars['message']->value['message_email'];?>
" placeholder="请输入邮箱" class="span6 m-wrap" />
											<span class="help-inline">请输入正确的邮箱地址</span>
										</div>
									</div>
									<div class="control-group">
										<label class="control-label">留言内容：</label>
										<div class="controls">
											<input class="span6 m-wrap" type="text" name="message_note" value="<?php echo $_smarty_tpl->tpl_vars['message']->value['message_note'];?>
" placeholder="请输入内容" />
										</div>
									</div>
