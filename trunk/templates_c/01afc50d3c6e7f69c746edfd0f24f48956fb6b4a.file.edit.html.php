<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-04-18 22:46:59
         compiled from "/Library/WebServer/Documents/blog/yunguan/trunk/application/views/admin/jysysteminbound/edit.html" */ ?>
<?php /*%%SmartyHeaderCode:113345230358f626e3bdf895-06882477%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '01afc50d3c6e7f69c746edfd0f24f48956fb6b4a' => 
    array (
      0 => '/Library/WebServer/Documents/blog/yunguan/trunk/application/views/admin/jysysteminbound/edit.html',
      1 => 1492526635,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '113345230358f626e3bdf895-06882477',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_58f626e3c5b893_00095108',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58f626e3c5b893_00095108')) {function content_58f626e3c5b893_00095108($_smarty_tpl) {?><!DOCTYPE html>
					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							<li>
								...
								<a href="/Admin_JySystemInbound/index">国内游配置管理</a>
							</li>
						</ul>
					</div>
				</div>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i>国内游配置修改</div>
								<div class="tools">
							...
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form action="/Admin_JySystemInbound/edit?system_class=<?php if (!empty($_smarty_tpl->tpl_vars['system_class']->value)) {
echo $_smarty_tpl->tpl_vars['system_class']->value;
}?>" method="post" class="form-horizontal" enctype="multipart/form-data" >
									<div class="control-group">
										<label class="control-label">名称：</label>
										<div class="controls">
											<input type="hidden" name="system_type" value="2">
											<input type="hidden" name="system_id" value="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_id'];?>
">
											<input type="text" name="system_name" placeholder="请输入内容标题，最少2位字符" minlength="2" maxlength="48" class="span6 m-wrap" value="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_name'];?>
" />
									...
									<div class="control-group">
										...
										<div class="controls">
											<select class="span6 select2" id="select2_sample1" name="system_class" data-placeholder="Choose a Category" >
...
?>
												<?php if ($_smarty_tpl->tpl_vars['system']->value['system_class']==$_smarty_tpl->tpl_vars['k']->value) {?>
...
"><?php echo $_smarty_tpl->tpl_vars['v']->value;?>
											...
											<span class="help-inline">&nbsp;请选择配置分类</span>
										</div>
									</div>
									<div class="control-group">
									...
									<div class="control-group">
										...
										<div class="controls">
											<textarea class="span6 m-wrap" name="system_note" id="" cols="30" rows="3" placeholder="请输入备注"><?php echo $_smarty_tpl->tpl_vars['system']->value['system_note'];?>
</textarea>
										</div>
									</div>
