<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-03-16 15:07:42
         compiled from "/Library/WebServer/Documents/blog/yunguan/trunk/application/views/default/around/details.html" */ ?>
<?php /*%%SmartyHeaderCode:129174851358c96e6c48af88-05207433%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '73e8bed2da3707fca4c2414e0b62fae1db98078e' => 
    array (
      0 => '/Library/WebServer/Documents/blog/yunguan/trunk/application/views/default/around/details.html',
      1 => 1489647587,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '129174851358c96e6c48af88-05207433',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_58c96e6c5364b7_64930528',
  'variables' => 
  array (
    'around' => 0,
  ),
...
<?php if ($_valid && !is_callable('content_58c96e6c5364b7_64930528')) {function content_58c96e6c5364b7_64930528($_smarty_tpl) {?><!DOCTYPE html>
    ...
    <div class="jy-m-0 jy-w-1">
        <div class="jy-m- jy-bg-7 jy-p-2 jy-border-5">
            ...
            <div id="slidepic" class="jy-f-left">
                <div id="bigpicbox">
                    <ul>
                        <li class="shows"><img src="<?php echo $_smarty_tpl->tpl_vars['around']->value['around_pic1'];?>
" width="480" height="320" /> </li>
                        <li><img src="<?php echo $_smarty_tpl->tpl_vars['around']->value['around_pic2'];?>
" width="480" height="320" /> </li>
                        <li><img src="<?php echo $_smarty_tpl->tpl_vars['around']->value['around_pic3'];?>
" width="480" height="320" /> </li>
                        <li><img src="<?php echo $_smarty_tpl->tpl_vars['around']->value['around_pic4'];?>
" width="480" height="320" /> </li>
                    </ul>
                </div>
                ...
                <div id="spicbox" class="spicbox" >
                    <ul>
                        <li class="select5"><img src="<?php echo $_smarty_tpl->tpl_vars['around']->value['around_pic1'];?>
" /> </li>
                        <li><img src="<?php echo $_smarty_tpl->tpl_vars['around']->value['around_pic2'];?>
" /> </li>
                        <li><img src="<?php echo $_smarty_tpl->tpl_vars['around']->value['around_pic3'];?>
...
" /> </li>
            ...
            <div class="jy-f-left cont-div" >
                <h3 id="h3-title"><?php echo $_smarty_tpl->tpl_vars['around']->value['around_name'];?>
</h3>
                <label><i>出发地</i><em><?php echo $_smarty_tpl->tpl_vars['around']->value['around_start_name'];?>
</em></label>
                <label><i>目的地</i><em><?php echo $_smarty_tpl->tpl_vars['around']->value['around_end_name'];?>
</em></label>
                <span id="table-box">
							<dd><em>￥<?php echo $_smarty_tpl->tpl_vars['around']->value['around_market_price'];?>
<i>起/份</i></em><b>￥<?php echo $_smarty_tpl->tpl_vars['around']->value['around_cost_price'];?>
/起</b></dd>
							<button type="button" value="" id="nybut">立即抢购</button>
						</span>
                <label><i>商家地址</i><?php echo $_smarty_tpl->tpl_vars['around']->value['around_address'];?>
</label>
                <dl>
                    <dt><?php echo $_smarty_tpl->tpl_vars['around']->value['around_tel'];?>
</dt>
                    <dd>免费资讯电话</dd>
                </dl>
...
<div id="fromshow">
    ...
    <div class="formdiv">
        <form method="post" action="/around/order_add" name="" enctype="multipart/form-data">
            <div id="myform2">
                <h3 id="fromh3"></h3>
                <input type="hidden" name="order_class_tour" value="周边游" >
                <input type="hidden" name="source" value="details" >
                <input type="hidden" name="order_name" value="<?php echo $_smarty_tpl->tpl_vars['around']->value['around_name'];?>
" >
                <input type="hidden" name="order_correlation" value="<?php echo $_smarty_tpl->tpl_vars['around']->value['around_id'];?>
" >
