<?php /* Smarty version Smarty-3.1.21-dev, created on 2016-12-20 18:40:26
         compiled from "/Library/WebServer/Documents/article/news/trunk/application/views/admin/mymenu/edit.html" */ ?>
<?php /*%%SmartyHeaderCode:17473271558590a9a6319e1-85149888%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '09068003b0eb75bf26a95d6ae0472770f01be55c' => 
    array (
      0 => '/Library/WebServer/Documents/article/news/trunk/application/views/admin/mymenu/edit.html',
      1 => 1481195379,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '17473271558590a9a6319e1-85149888',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_58590a9a6cdf56_06335861',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58590a9a6cdf56_06335861')) {function content_58590a9a6cdf56_06335861($_smarty_tpl) {?><!DOCTYPE html>
...
"/>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="checkbox" class="toggle" name="menu_hide" <?php if ($_smarty_tpl->tpl_vars['menu_info']->value['menu_hide']==1) {?>checked="checked"<?php }?> value="1" /> <span class="help-inline">是</span>
										<input type="checkbox" class="toggle" name="menu_hide" <?php if ($_smarty_tpl->tpl_vars['menu_info']->value['menu_hide']==0) {?>checked="checked"<?php }?> value="0" /> <span class="help-inline">否</span>
									</div>
								</div>
