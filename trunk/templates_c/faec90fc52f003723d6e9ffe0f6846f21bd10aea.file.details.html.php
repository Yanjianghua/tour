<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-03-16 18:36:17
         compiled from "/Library/WebServer/Documents/blog/yunguan/trunk/application/views/default/outbound/details.html" */ ?>
<?php /*%%SmartyHeaderCode:190981259658ca6aa10fe100-60377471%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'faec90fc52f003723d6e9ffe0f6846f21bd10aea' => 
    array (
      0 => '/Library/WebServer/Documents/blog/yunguan/trunk/application/views/default/outbound/details.html',
      1 => 1489657303,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '190981259658ca6aa10fe100-60377471',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_58ca6aa1184bb4_10601164',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58ca6aa1184bb4_10601164')) {function content_58ca6aa1184bb4_10601164($_smarty_tpl) {?><!DOCTYPE html>
...
<head>
    <meta charset="utf-8" />
    <title>周边游-<?php echo $_smarty_tpl->tpl_vars['outbound']->value['outbound_name'];?>
</title>
    ...
    <div class="jy-m-0 jy-w-1">
        <div class="jy-m- jy-bg-7 jy-p-2 jy-border-5">
            ...
            <div id="slidepic" class="jy-f-left">
                <div id="bigpicbox">
                    <ul>
                        <li class="shows"><img src="<?php echo $_smarty_tpl->tpl_vars['outbound']->value['outbound_pic1'];?>
" width="480" height="320" /> </li>
                        <li><img src="<?php echo $_smarty_tpl->tpl_vars['outbound']->value['outbound_pic2'];?>
" width="480" height="320" /> </li>
                        <li><img src="<?php echo $_smarty_tpl->tpl_vars['outbound']->value['outbound_pic3'];?>
" width="480" height="320" /> </li>
                        <li><img src="<?php echo $_smarty_tpl->tpl_vars['outbound']->value['outbound_pic4'];?>
" width="480" height="320" /> </li>
                    </ul>
                </div>
                ...
                <div id="spicbox" class="spicbox" >
                    <ul>
                        <li class="select5"><img src="<?php echo $_smarty_tpl->tpl_vars['outbound']->value['outbound_pic1'];?>
" /> </li>
                        <li><img src="<?php echo $_smarty_tpl->tpl_vars['outbound']->value['outbound_pic2'];?>
" /> </li>
                        <li><img src="<?php echo $_smarty_tpl->tpl_vars['outbound']->value['outbound_pic3'];?>
...
" /> </li>
            ...
            <div class="jy-f-left cont-div" >
                <h3 id="h3-title"><?php echo $_smarty_tpl->tpl_vars['outbound']->value['outbound_name'];?>
</h3>
                <label><i>出发地</i><em><?php echo $_smarty_tpl->tpl_vars['outbound']->value['outbound_start_name'];?>
</em></label>
                <label><i>目的地</i><em><?php echo $_smarty_tpl->tpl_vars['outbound']->value['outbound_end_name'];?>
</em></label>
                <span id="table-box">
							<dd><em>￥<?php echo $_smarty_tpl->tpl_vars['outbound']->value['outbound_market_price'];?>
<i>起/份</i></em><b>￥<?php echo $_smarty_tpl->tpl_vars['outbound']->value['outbound_cost_price'];?>
/起</b></dd>
							<button type="button" value="" id="nybut">立即抢购</button>
						</span>
                <label><i>商家地址</i><?php echo $_smarty_tpl->tpl_vars['outbound']->value['outbound_address'];?>
</label>
                <dl>
                    <dt><?php echo $_smarty_tpl->tpl_vars['outbound']->value['outbound_tel'];?>
</dt>
                    <dd>免费资讯电话</dd>
                </dl>
        ...
        <div class="jy-bg-3 jy-m-2 jy-border-5">
            ...
            <div class="text-content jy-p-2">
                <?php echo $_smarty_tpl->tpl_vars['outbound']->value['outbound_details'];?>
        ...
        <div class="jy-bg-3 jy-m-2 jy-border-5">
            ...
            <div class="text-content jy-p-2">
                <?php echo $_smarty_tpl->tpl_vars['outbound']->value['outbound_explain'];?>
...
<div id="fromshow">
    ...
    <div class="formdiv">
        <form method="post" action="/outbound/order_add" name="" enctype="multipart/form-data">
            <div id="myform2">
                <h3 id="fromh3"></h3>
                <input type="hidden" name="order_class_tour" value="出境游" >
                <input type="hidden" name="source" value="details" >
                <input type="hidden" name="order_name" value="<?php echo $_smarty_tpl->tpl_vars['outbound']->value['outbound_name'];?>
" >
                <input type="hidden" name="order_correlation" value="<?php echo $_smarty_tpl->tpl_vars['outbound']->value['outbound_id'];?>
" >
