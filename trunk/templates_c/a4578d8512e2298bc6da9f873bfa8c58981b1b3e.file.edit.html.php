<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-02-22 23:23:06
         compiled from "/Library/WebServer/Documents/blog/blog/trunk/application/views/admin/myblogarticle/edit.html" */ ?>
<?php /*%%SmartyHeaderCode:374262724586254d56ec257-81725353%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a4578d8512e2298bc6da9f873bfa8c58981b1b3e' => 
    array (
      0 => '/Library/WebServer/Documents/blog/blog/trunk/application/views/admin/myblogarticle/edit.html',
      1 => 1487776985,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '374262724586254d56ec257-81725353',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_586254d5741c58_57111797',
  'variables' => 
  array (
    'web_name' => 0,
    'article' => 0,
...
<?php if ($_valid && !is_callable('content_586254d5741c58_57111797')) {function content_586254d5741c58_57111797($_smarty_tpl) {?><!DOCTYPE html>
...
"/>
											<input type="text" name="article_title" value="<?php echo $_smarty_tpl->tpl_vars['article']->value['article_title'];?>
" placeholder="请输入内容标题，最少2位字符" minlength="2" maxlength="18" class="span6 m-wrap" />
...
?>
												<?php if ($_smarty_tpl->tpl_vars['article']->value['channel_id']==$_smarty_tpl->tpl_vars['v']->value['channel_id']) {?>
												<option value="<?php echo $_smarty_tpl->tpl_vars['v']->value['channel_id'];?>
" selected><?php echo $_smarty_tpl->tpl_vars['v']->value['channel_name'];?>
</option>
												<?php } else { ?>
												<option value="<?php echo $_smarty_tpl->tpl_vars['v']->value['channel_id'];?>
...
" <?php echo label_id($_smarty_tpl->tpl_vars['v']->value['label_id'],$_smarty_tpl->tpl_vars['article']->value['label_id']);?>
 /> <span class="help-inline"><?php echo $_smarty_tpl->tpl_vars['v']->value['label_name'];?>
									...
									<div class="control-group">
										...
										<div class="controls">
											<input class="span6 m-wrap" type="text" name="article_keywords" value="<?php echo $_smarty_tpl->tpl_vars['article']->value['article_keywords'];?>
" placeholder="请输入关键字" />
									...
									<div class="control-group">
										...
										<div class="controls">
											<textarea class="span6 m-wrap" name="article_description" id="" cols="30" rows="3" placeholder="请输入描述"><?php echo $_smarty_tpl->tpl_vars['article']->value['article_description'];?>
</textarea>
										</div>
									</div>
									<div class="control-group">
										...
										<div class="controls">
											<input class="span6 m-wrap" type="text" name="article_editor" value="<?php echo $_smarty_tpl->tpl_vars['article']->value['article_editor'];?>
" placeholder="请输入作者" />
									...
									<div class="control-group">
										...
										<div class="controls">
											<textarea id="content123" name="article_content" ><?php echo $_smarty_tpl->tpl_vars['article']->value['article_content'];?>
</textarea>
											<?php echo '<script'; ?>
...
>
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<?php if (!empty($_smarty_tpl->tpl_vars['article']->value['pic_url'])) {?><span class="help-inline">已上传图片：</span><img src="<?php echo $_smarty_tpl->tpl_vars['article']->value['pic_url'];?>
" height="100px" width="100px"><?php }?>
									...
									<div class="control-group">
										...
										<div class="controls">
											<input class="span6 m-wrap" type="text" name="article_url" value="<?php echo $_smarty_tpl->tpl_vars['article']->value['article_url'];?>
" placeholder="请输入原文链接" />
									...
									<div class="control-group">
										...
										<div class="controls">
											<input class="span6 m-wrap" type="date" name="addtime" value="<?php echo date('Y-m-d',$_smarty_tpl->tpl_vars['article']->value['addtime']);?>
" />
