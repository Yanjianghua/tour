<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-04-18 23:02:24
         compiled from "/Library/WebServer/Documents/blog/yunguan/trunk/application/views/admin/jysystemticket/index.html" */ ?>
<?php /*%%SmartyHeaderCode:118706114158f62a80dc4a69-83197194%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4fc615c1b585b3469c26e08baabddb0a0e35040d' => 
    array (
      0 => '/Library/WebServer/Documents/blog/yunguan/trunk/application/views/admin/jysystemticket/index.html',
      1 => 1492527736,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '118706114158f62a80dc4a69-83197194',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_58f62a80eb20d9_24138849',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58f62a80eb20d9_24138849')) {function content_58f62a80eb20d9_24138849($_smarty_tpl) {?><!DOCTYPE html>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-list"></i>景点门票配置内容列表</div>
								<div class="tools">
							...
							<div class="portlet-body">
								<div class="clearfix">
									<div class="btn-group">
										<button onclick="location='/Admin_JySystemTicket/add'" class="btn green" >
											新建内容 <i class="icon-plus"></i>
										</button>
									</div>
									<div class="btn-group pull-right">
										<form action="/Admin_JySystemTicket/index" method="get" class="form-horizontal" style="margin:0;" enctype="multipart/form-data" >
											<div class="btn-group">
...
?>
									<tr class="">
										...
										<td>
										<a class="btn_g icn-only <?php if ($_smarty_tpl->tpl_vars['v']->value['status']) {?>yellow<?php } else { ?>blue<?php }?>" href="/Admin_JySystemTicket/<?php if ($_smarty_tpl->tpl_vars['v']->value['status']) {?>disable<?php } else { ?>enable<?php }?>?system_id=<?php echo $_smarty_tpl->tpl_vars['v']->value['system_id'];?>
">
											<?php echo status_btn($_smarty_tpl->tpl_vars['v']->value['status']);?>

										</a>&nbsp;&nbsp;
										<a class="btn_g purple icn-only" href="/Admin_JySystemTicket/edit?system_id=<?php echo $_smarty_tpl->tpl_vars['v']->value['system_id'];?>
&system_class=<?php if (!empty($_smarty_tpl->tpl_vars['system_class']->value)) {
echo $_smarty_tpl->tpl_vars['system_class']->value;
}?>">
											修改
										</a>&nbsp;&nbsp;
										<a class="btn_g red icn-only" href="/Admin_JySystemTicket/del?system_id=<?php echo $_smarty_tpl->tpl_vars['v']->value['system_id'];?>
">
											删除
										</a>
										</td>
