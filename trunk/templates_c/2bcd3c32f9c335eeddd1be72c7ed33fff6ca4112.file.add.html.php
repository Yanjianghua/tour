<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-03-10 16:43:11
         compiled from "/Library/WebServer/Documents/blog/yunguan/trunk/application/views/admin/jyorder/add.html" */ ?>
<?php /*%%SmartyHeaderCode:28218810758c25a9e93c7e7-92780190%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2bcd3c32f9c335eeddd1be72c7ed33fff6ca4112' => 
    array (
      0 => '/Library/WebServer/Documents/blog/yunguan/trunk/application/views/admin/jyorder/add.html',
      1 => 1489134654,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '28218810758c25a9e93c7e7-92780190',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_58c25a9e98b8e9_16771440',
  'variables' => 
  array (
    'web_name' => 0,
    'order_array' => 0,
...
<?php if ($_valid && !is_callable('content_58c25a9e98b8e9_16771440')) {function content_58c25a9e98b8e9_16771440($_smarty_tpl) {?><!DOCTYPE html>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i>预约客户添加</div>
								<div class="tools">
							...
							<div class="portlet-body form">
								...
								<form action="/Admin_JyOrder/add" method="post" class="form-horizontal" enctype="multipart/form-data" >
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="order_name" placeholder="请输入预约名称，最少2位字符" minlength="2" maxlength="98" class="span6 m-wrap" />
...
"><?php echo $_smarty_tpl->tpl_vars['v']->value;?>
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="order_correlation" placeholder="请输入显示位置，最少2位字符"  class="span6 m-wrap" />
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="order_username" placeholder="请输入客户名称，最少2位字符" minlength="2" maxlength="98" class="span6 m-wrap" />
											<span class="help-inline">请输入2～98位非特殊字符</span>
										</div>
									</div>
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="order_tel" placeholder="请输入手机号" minlength="11" maxlength="11" class="span6 m-wrap" />
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="date" name="order_start_time" placeholder="请输入出行时间" class="span6 m-wrap" />
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="number" name="order_adult" max="100" min="1" value="1" placeholder="请输入成人数量" class="span6 m-wrap" />
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="number" name="order_children" max="100" min="1" value="0" placeholder="请输入儿童数量" class="span6 m-wrap" />
