<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-03-09 20:49:53
         compiled from "/Library/WebServer/Documents/blog/yunguan/trunk/application/views/admin/jyad/add.html" */ ?>
<?php /*%%SmartyHeaderCode:140397962958c13ed4a11dc4-67627195%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '08d75faf7e3f2ec4c6d2a646c7aae0f338b4e9d0' => 
    array (
      0 => '/Library/WebServer/Documents/blog/yunguan/trunk/application/views/admin/jyad/add.html',
      1 => 1489063749,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '140397962958c13ed4a11dc4-67627195',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_58c13ed4a69a31_55924013',
  'variables' => 
  array (
    'web_name' => 0,
  ),
...
<?php if ($_valid && !is_callable('content_58c13ed4a69a31_55924013')) {function content_58c13ed4a69a31_55924013($_smarty_tpl) {?><!DOCTYPE html>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i>广告位添加</div>
								<div class="tools">
							...
							<div class="portlet-body form">
								...
								<form action="/Admin_JyPicAd/add" method="post" class="form-horizontal" enctype="multipart/form-data" >
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="ad_title" placeholder="请输入内容标题，最少2位字符" minlength="2" maxlength="48" class="span6 m-wrap" />
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="ad_position" placeholder="请输入显示位置，最少2位字符" minlength="2" maxlength="48" class="span6 m-wrap" />
											<span class="help-inline">请输入2～18位非特殊字符</span>
										</div>
									</div>
									<div class="control-group">
										...
										<div class="controls">
											<input type="radio" class="toggle" name="ad_hide" value="1" /> <span class="help-inline">是</span>
											<input type="radio" class="toggle" name="ad_hide" checked="checked" value="0" /> <span class="help-inline">否</span>
										</div>
									</div>
									<div class="control-group">
