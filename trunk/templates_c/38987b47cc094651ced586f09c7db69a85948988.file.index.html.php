<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-04-18 15:12:21
         compiled from "/Library/WebServer/Documents/blog/yunguan/trunk/application/views/admin/jyad/index.html" */ ?>
<?php /*%%SmartyHeaderCode:40270554358c12285838fd7-25466214%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '38987b47cc094651ced586f09c7db69a85948988' => 
    array (
      0 => '/Library/WebServer/Documents/blog/yunguan/trunk/application/views/admin/jyad/index.html',
      1 => 1492499268,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '40270554358c12285838fd7-25466214',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_58c12285916dc3_51556212',
  'variables' => 
  array (
    'web_name' => 0,
    'ad' => 0,
...
<?php if ($_valid && !is_callable('content_58c12285916dc3_51556212')) {function content_58c12285916dc3_51556212($_smarty_tpl) {?><!DOCTYPE html>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-list"></i>广告位内容列表</div>
								<div class="tools">
							...
							<div class="portlet-body">
								<div class="clearfix">
									<div class="btn-group">
										<button onclick="location='/Admin_JyPicAd/add'" class="btn green" >
...
?>
									<tr class="">
										...
										<td><?php echo $_smarty_tpl->tpl_vars['v']->value['ad_title'];?>
</td>
										<td><?php echo $_smarty_tpl->tpl_vars['v']->value['ad_position'];?>
</td>
										<td><?php echo menu_hide($_smarty_tpl->tpl_vars['v']->value['ad_hide']);?>
</td>
										<td style="width: 100px;height: 30px;"><img src="<?php echo $_smarty_tpl->tpl_vars['v']->value['ad_pic'];?>
"></td>
										<td><?php echo status($_smarty_tpl->tpl_vars['v']->value['status']);?>
</td>
										<td>
										<a class="btn_g icn-only <?php if ($_smarty_tpl->tpl_vars['v']->value['status']) {?>yellow<?php } else { ?>blue<?php }?>" href="/Admin_JyPicAd/<?php if ($_smarty_tpl->tpl_vars['v']->value['status']) {?>disable<?php } else { ?>enable<?php }?>?ad_id=<?php echo $_smarty_tpl->tpl_vars['v']->value['ad_id'];?>
">
											<?php echo status_btn($_smarty_tpl->tpl_vars['v']->value['status']);?>

										</a>&nbsp;&nbsp;
										<a class="btn_g purple icn-only" href="/Admin_JyPicAd/edit?ad_id=<?php echo $_smarty_tpl->tpl_vars['v']->value['ad_id'];?>
">
											修改
										</a>&nbsp;&nbsp;
										<a class="btn_g red icn-only" href="/Admin_JyPicAd/del?ad_id=<?php echo $_smarty_tpl->tpl_vars['v']->value['ad_id'];?>
">
											删除
										</a>
										</td>
