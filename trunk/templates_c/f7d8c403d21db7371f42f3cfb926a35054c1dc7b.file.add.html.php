<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-04-22 23:08:40
         compiled from "/Library/WebServer/Documents/blog/yunguan/trunk/application/views/admin/jytickettour/add.html" */ ?>
<?php /*%%SmartyHeaderCode:27969022658c109164ba019-68027436%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f7d8c403d21db7371f42f3cfb926a35054c1dc7b' => 
    array (
      0 => '/Library/WebServer/Documents/blog/yunguan/trunk/application/views/admin/jytickettour/add.html',
      1 => 1492873647,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '27969022658c109164ba019-68027436',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_58c10916570177_50203157',
  'variables' => 
  array (
    'web_name' => 0,
    'channel_1' => 0,
...
<?php if ($_valid && !is_callable('content_58c10916570177_50203157')) {function content_58c10916570177_50203157($_smarty_tpl) {?><!DOCTYPE html>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i>景点门票内容添加</div>
								<div class="tools">
							...
							<div class="portlet-body form">
								...
								<form action="/Admin_JyTicketTour/add" method="post" class="form-horizontal" enctype="multipart/form-data" >
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="ticket_name" placeholder="请输入内容标题，最少2位字符" minlength="2" maxlength="88" class="span6 m-wrap" />
...
"><?php echo $_smarty_tpl->tpl_vars['v']->value['system_name'];?>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input class="span6 m-wrap" type="text" name="ticket_spot" placeholder="请输入景点" />
									...
									<div class="control-group">
										...
										<div class="controls">
											<input class="span6 m-wrap" type="text" name="ticket_tel" placeholder="请输入商家电话" />
									...
									<div class="control-group">
										...
										<div class="controls">
											<input class="span6 m-wrap" type="text" name="ticket_address" placeholder="请输入商家地址" />
									...
									<div class="control-group">
										...
										<div class="controls">
											<input class="span6 m-wrap" type="text" name="ticket_cost_price" placeholder="请输入原价" />
									...
									<div class="control-group">
										...
										<div class="controls">
											<input class="span6 m-wrap" type="text" name="ticket_market_price" placeholder="请输入现价" />
									...
									<div class="control-group">
										...
										<div class="controls">
											<textarea id="content123" name="ticket_details" ></textarea>
											<?php echo '<script'; ?>
...
>
									...
									<div class="control-group">
										...
										<div class="controls">
											<textarea id="content12" name="ticket_explain" ></textarea>
											<?php echo '<script'; ?>
 type="text/javascript">
