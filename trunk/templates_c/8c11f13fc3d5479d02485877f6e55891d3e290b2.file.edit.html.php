<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-02-07 15:26:13
         compiled from "/Library/WebServer/Documents/blog/blog/trunk/application/views/admin/mybloglabel/edit.html" */ ?>
<?php /*%%SmartyHeaderCode:44007458585a9af087ddb0-24336854%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8c11f13fc3d5479d02485877f6e55891d3e290b2' => 
    array (
      0 => '/Library/WebServer/Documents/blog/blog/trunk/application/views/admin/mybloglabel/edit.html',
      1 => 1482839367,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '44007458585a9af087ddb0-24336854',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_585a9af08bd9e3_21877005',
  'variables' => 
  array (
    'web_name' => 0,
    'label' => 0,
...
<?php if ($_valid && !is_callable('content_585a9af08bd9e3_21877005')) {function content_585a9af08bd9e3_21877005($_smarty_tpl) {?><!DOCTYPE html>
					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							<li>
								...
								<a href="/Admin_MyUser/index">博客标签管理</a>
							</li>
						</ul>
					</div>
				</div>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i>博客标签修改</div>
								<div class="tools">
							...
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form action="/Admin_MyBlogLabel/edit" method="post" class="form-horizontal">
									<div class="control-group">
										<label class="control-label">标签名称：</label>
										<div class="controls">
											<input type="hidden" name="label_id" value="<?php echo $_smarty_tpl->tpl_vars['label']->value['label_id'];?>
"/>
											<input type="text" name="label_name" placeholder="请输入分类名称，最少2位字符" value="<?php echo $_smarty_tpl->tpl_vars['label']->value['label_name'];?>
" minlength="2" maxlength="18" class="span6 m-wrap" />
									...
									<div class="control-group">
										...
										<div class="controls">
											<input class="span6 m-wrap" type="text" name="label_note" value="<?php echo $_smarty_tpl->tpl_vars['label']->value['label_note'];?>
" placeholder="请输入备注" />
										</div>
									</div>
