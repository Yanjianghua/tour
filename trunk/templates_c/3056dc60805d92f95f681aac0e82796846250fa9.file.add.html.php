<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-04-18 22:55:25
         compiled from "/Library/WebServer/Documents/blog/yunguan/trunk/application/views/admin/jysystemoutbound/add.html" */ ?>
<?php /*%%SmartyHeaderCode:151800124958f628dde50368-26313022%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3056dc60805d92f95f681aac0e82796846250fa9' => 
    array (
      0 => '/Library/WebServer/Documents/blog/yunguan/trunk/application/views/admin/jysystemoutbound/add.html',
      1 => 1492527308,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '151800124958f628dde50368-26313022',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_58f628ddea6492_80114877',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58f628ddea6492_80114877')) {function content_58f628ddea6492_80114877($_smarty_tpl) {?><!DOCTYPE html>
					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							<li>
								...
								<a href="/Admin_JySystemOutbound/index">出境游配置管理</a>
							</li>
						</ul>
					</div>
				</div>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i>出境游配置添加</div>
								<div class="tools">
							...
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form action="/Admin_JySystemOutbound/add" method="post" class="form-horizontal" enctype="multipart/form-data" >
									<div class="control-group">
										<label class="control-label">名称：</label>
										<div class="controls">
											<input type="hidden" name="system_type" value="3">
