<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-03-16 18:37:41
         compiled from "/Library/WebServer/Documents/blog/yunguan/trunk/application/views/default/local/details.html" */ ?>
<?php /*%%SmartyHeaderCode:147890136558ca6af5b25727-33432238%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '89e644cda93a29e798da68f98dadccc98e3768c7' => 
    array (
      0 => '/Library/WebServer/Documents/blog/yunguan/trunk/application/views/default/local/details.html',
      1 => 1489660524,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '147890136558ca6af5b25727-33432238',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_58ca6af5ba8d73_73115531',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58ca6af5ba8d73_73115531')) {function content_58ca6af5ba8d73_73115531($_smarty_tpl) {?><!DOCTYPE html>
    ...
    <div class="jy-m-0 jy-w-1">
        <div class="jy-m- jy-bg-7 jy-p-2 jy-border-5">
            ...
            <div id="slidepic" class="jy-f-left">
                <div id="bigpicbox">
                    <ul>
                        <li class="shows"><img src="<?php echo $_smarty_tpl->tpl_vars['local']->value['local_pic1'];?>
" width="480" height="320" /> </li>
                        <li><img src="<?php echo $_smarty_tpl->tpl_vars['local']->value['local_pic2'];?>
" width="480" height="320" /> </li>
                        <li><img src="<?php echo $_smarty_tpl->tpl_vars['local']->value['local_pic3'];?>
" width="480" height="320" /> </li>
                        <li><img src="<?php echo $_smarty_tpl->tpl_vars['local']->value['local_pic4'];?>
" width="480" height="320" /> </li>
                    </ul>
                </div>
                ...
                <div id="spicbox" class="spicbox" >
                    <ul>
                        <li class="select5"><img src="<?php echo $_smarty_tpl->tpl_vars['local']->value['local_pic1'];?>
" /> </li>
                        <li><img src="<?php echo $_smarty_tpl->tpl_vars['local']->value['local_pic2'];?>
" /> </li>
                        <li><img src="<?php echo $_smarty_tpl->tpl_vars['local']->value['local_pic3'];?>
...
" /> </li>
            ...
            <div class="jy-f-left cont-div" >
                <h3 id="h3-title"><?php echo $_smarty_tpl->tpl_vars['local']->value['local_name'];?>
</h3>
                <label><i>出发地</i><em><?php echo $_smarty_tpl->tpl_vars['local']->value['local_start_name'];?>
</em></label>
                <label><i>目的地</i><em><?php echo $_smarty_tpl->tpl_vars['local']->value['local_end_name'];?>
</em></label>
                <span id="table-box">
							<dd><em>￥<?php echo $_smarty_tpl->tpl_vars['local']->value['local_market_price'];?>
<i>起/份</i></em><b>￥<?php echo $_smarty_tpl->tpl_vars['local']->value['local_cost_price'];?>
/起</b></dd>
							<button type="button" value="" id="nybut">立即抢购</button>
						</span>
                <label><i>商家地址</i><?php echo $_smarty_tpl->tpl_vars['local']->value['local_address'];?>
</label>
                <dl>
                    <dt><?php echo $_smarty_tpl->tpl_vars['local']->value['local_tel'];?>
</dt>
                    <dd>免费资讯电话</dd>
                </dl>
...
<div id="fromshow">
    ...
    <div class="formdiv">
        <form method="post" action="/local/order_add" name="" enctype="multipart/form-data">
            <div id="myform2">
                <h3 id="fromh3"></h3>
                <input type="hidden" name="order_class_tour" value="本地游玩" >
                <input type="hidden" name="source" value="details" >
                <input type="hidden" name="order_name" value="<?php echo $_smarty_tpl->tpl_vars['local']->value['local_name'];?>
" >
                <input type="hidden" name="order_correlation" value="<?php echo $_smarty_tpl->tpl_vars['local']->value['local_id'];?>
" >
