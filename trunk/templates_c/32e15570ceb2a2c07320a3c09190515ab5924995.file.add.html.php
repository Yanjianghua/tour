<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-04-22 22:46:58
         compiled from "/Library/WebServer/Documents/blog/yunguan/trunk/application/views/admin/jyinboundtour/add.html" */ ?>
<?php /*%%SmartyHeaderCode:66068935458c0f09cb2e487-15935375%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '32e15570ceb2a2c07320a3c09190515ab5924995' => 
    array (
      0 => '/Library/WebServer/Documents/blog/yunguan/trunk/application/views/admin/jyinboundtour/add.html',
      1 => 1492872303,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '66068935458c0f09cb2e487-15935375',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_58c0f09cbe8349_50427395',
  'variables' => 
  array (
    'web_name' => 0,
    'channel_1' => 0,
...
<?php if ($_valid && !is_callable('content_58c0f09cbe8349_50427395')) {function content_58c0f09cbe8349_50427395($_smarty_tpl) {?><!DOCTYPE html>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i>国内游内容添加</div>
								<div class="tools">
							...
							<div class="portlet-body form">
								...
								<form action="/Admin_JyInboundTour/add" method="post" class="form-horizontal" enctype="multipart/form-data" >
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="inbound_name" placeholder="请输入内容标题，最少2位字符" minlength="2" maxlength="88" class="span6 m-wrap" />
...
"><?php echo $_smarty_tpl->tpl_vars['v']->value['system_name'];?>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input class="span6 m-wrap" type="text" name="inbound_spot" placeholder="请输入景点" />
									...
									<div class="control-group">
										...
										<div class="controls">
											<input class="span6 m-wrap" type="text" name="inbound_tel" placeholder="请输入商家电话" />
									...
									<div class="control-group">
										...
										<div class="controls">
											<input class="span6 m-wrap" type="text" name="inbound_address" placeholder="请输入商家地址" />
									...
									<div class="control-group">
										...
										<div class="controls">
											<input class="span6 m-wrap" type="text" name="inbound_cost_price" placeholder="请输入原价" />
									...
									<div class="control-group">
										...
										<div class="controls">
											<input class="span6 m-wrap" type="text" name="inbound_market_price" placeholder="请输入现价" />
									...
									<div class="control-group">
										...
										<div class="controls">
											<textarea id="content123" name="inbound_details" ></textarea>
											<?php echo '<script'; ?>
...
>
									...
									<div class="control-group">
										...
										<div class="controls">
											<textarea id="content12" name="inbound_explain" ></textarea>
											<?php echo '<script'; ?>
 type="text/javascript">
